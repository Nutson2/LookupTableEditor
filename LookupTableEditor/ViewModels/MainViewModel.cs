...
public partial class MainViewModel : BaseViewModel
{
	...
	internal void ClearSelection(List<Cell> cells)
	{
		SizeTableInfo?.FillTableCells(cells);
	}
	...
	{
		SizeTableInfo?.AddRow(SelectedRowIndex);
	}

	[RelayCommand]
	private void RemoveRow()
	{
		SizeTableInfo?.RemoveRow(SelectedRowIndex);
	}

	[RelayCommand]
	private void RemoveColumn()
	{
		SizeTableInfo?.RemoveColumn(SelectedColumnIndex);
		RefreshSizeTableInfo();
	}
	...
	private void RefreshSizeTableInfo()
	{
